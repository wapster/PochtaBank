...
--
-- Host: localhost
-- Generation Time: Oct 08, 2016 at 10:18 PM
...
--
-- Table structure for table `bankomat`
--
...
(2, 'Клиентский центр в отделении Почты России\r\n(сотрудник Почты России)'),
(3, 'Клиентский центр'),
(4, 'qewfdfd');
...
--
-- AUTO_INCREMENT for table `bankomat`
--
ALTER TABLE `bankomat`
